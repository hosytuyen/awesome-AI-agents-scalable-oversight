...
<th style="min-width: 450px; padding: 8px;">🧠 Title</th>
<th style="min-width: 250px; padding: 8px;">🏷️ Tags</th>
...
<td style="padding: 8px;">AI Debate, scalable oversight, Language Model Alignment, Persuasion, Belief Elicitation, Sycophancy</td>
...
<td style="padding: 8px;">reward modeling, rubrics, RLHF, LLM Alignment, scalable oversight</td>
...
<td style="padding: 8px;">Chain-of-Thought Reasoning, Faithfulness, Causal Intervention, Direct Preference Optimization, scalable alignment</td>
...
<td style="padding: 8px;">Emotional Safety, LLM Safety, scalable alignment, Mental Health Applications, Fine-tuning</td>
...
<td style="padding: 8px;">prompt engineering, Weak-to-Strong Transfer, reinforcement learning, LLM Alignment, scalable oversight</td>
...
<td style="padding: 8px;">Runtime Governance, Agentic AI, AI safety, scalable oversight, risk management</td>
...
<td style="padding: 8px;">LLM Alignment, scalable oversight, Safety Mechanisms, preference learning, robustness</td>
...
<td style="padding: 8px;">Chain of Thought, Monitorability, AI safety, scalable oversight, Intent Detection</td>
...
<td style="padding: 8px;">scalable oversight, memory verification, computer-using agents, Alignment, human-in-the-loop, policy drift, domain-specific</td>
...
<td style="padding: 8px;">AI Debate, scalable oversight, Bias Mitigation, Truth Seeking, COVID-19 Factuality</td>
...
<td style="padding: 8px;">LLMs, Alignment, scalable oversight, No-Consensus Tasks, Bias</td>
...
<td style="padding: 8px;">scalable oversight, Deception, preference learning, Lie Detection, AI Alignment</td>
...
<td style="padding: 8px;">debate, scalable oversight, multimodal learning, visual question answering, AI Alignment</td>
<td style="padding: 8px; white-space: nowrap;">2025-05-20</td>
...
<td style="padding: 8px;">scalable oversight, confirmation bias, Human-AI Interaction, AI safety, Cognitive Bias</td>
...
<td style="padding: 8px;">Algorithmic Innovation, compute-independent advancements, compute-dependent advancements, AI Oversight, capability forecasting</td>
...
<td style="padding: 8px;">LLM Critique, Automated Oversight, reinforcement learning, Math Reasoning, Error Identification</td>
...
<td style="padding: 8px;">scalable oversight, AI safety, nested oversight, capability mismatch, scaling laws</td>
...
<td style="padding: 8px;">superalignment, co-alignment, scalable oversight, AI safety, value alignment, symbiotic AI</td>
...
<td style="padding: 8px;">reward modeling, Adversarial Training, robustness, reward hacking, RLHF, scalable oversight</td>
...
<td style="padding: 8px;">scalable oversight, AI Alignment, human feedback, Benchmarking, debate</td>
...
<td style="padding: 8px;">scalable oversight, AI safety, error detection, critique, dataset</td>
...
<td style="padding: 8px;">scalable oversight, Dynamic Human Values, Recursive Reward Modeling, Task Decomposition, Part-to-Complete Generalization</td>
...
<td style="padding: 8px;">scalable oversight, belief modeling, value learning, human feedback, AI Alignment</td>
...
<td style="padding: 8px;">scalable oversight, recursive self-critiquing, AI Alignment, Human-AI Interaction, AI-AI interaction</td>
...
<td style="padding: 8px;">AI Oversight, Model Similarity, Weak-to-Strong Generalization, Correlated Failures, Language Model Evaluation</td>
...
<td style="padding: 8px;">Participatory AI, AI Governance, scalable oversight, Human-Centered AI, AI Alignment</td>
...
<td style="padding: 8px;">Weak-to-Strong Generalization, scalable oversight, debate, AI Alignment, Human Supervision</td>
...
<td style="padding: 8px;">RLHF, Influence Functions, reward modeling, human feedback, Bias Detection, scalable oversight</td>
...
<td style="padding: 8px;">superalignment, scalable oversight, ASI, AI safety, alignment paradigms</td>
...
<td style="padding: 8px;">superalignment, scalable oversight, Weak-to-Strong Generalization, Adversarial Training, AI safety</td>
...
<td style="padding: 8px;">uncertainty estimation, LLM, scalable oversight, hallucination detection, multi-agent systems</td>
...
<td style="padding: 8px;">scalable oversight, error detection, mathematical reasoning, process reward models, critic models</td>
...
<td style="padding: 8px;">scalable oversight, label quality, label quantity, pretrained models, sample efficiency, elicitation, cost-benefit analysis</td>
...
<td style="padding: 8px;">scalable oversight, Modular Neural Networks, Interpretability, Unlearning, Reinforcement Learning Alignment</td>
...
<td style="padding: 8px;">scalable alignment, Structure Learning, Causal Representation Learning, Theory of Mind, preference learning</td>
...
<td style="padding: 8px;">debate, scalable oversight, Language Models, self-play, judge accuracy</td>
...
<td style="padding: 8px;">Weak-to-Strong Generalization, model alignment, Explanation Generation, multi-agent systems, scalable oversight</td>
...
<td style="padding: 8px;">LLM, Question Generation, Difficulty, Metacognition, human-in-the-loop, Out-of-Distribution, scalable oversight</td>
...
<td style="padding: 8px;">hallucination detection, scalable oversight, self-training, expectation maximization, LLM Evaluation</td>
...
<td style="padding: 8px;">scalable oversight, debate, Language Models, AI Alignment, Weak-to-Strong Generalization</td>
<td style="padding: 8px; white-space: nowrap;">2024-07-05</td>
...
<td style="padding: 8px;">scalable oversight, reward modeling, Easy-to-Hard Generalization, AI Alignment, reasoning</td>
...
<td style="padding: 8px;">Alignment, big models, scalable oversight, RLHF, SFT</td>
...
<td style="padding: 8px;">LLM Evaluation, critique ability, scalable oversight, AI safety, benchmark</td>
...
<td style="padding: 8px;">Weak-to-Strong Generalization, scalable oversight, Ensemble Learning, Human-AI Interaction, AI Alignment</td>
...
<td style="padding: 8px;">goal misgeneralization, LLM feedback, reinforcement learning, scalable oversight, reward shaping</td>
...
<td style="padding: 8px;">scalable oversight, Easy-to-Hard Generalization, Language Models, Data Efficiency, Weak Supervision</td>
...
<td style="padding: 8px;">scalable oversight, AI Alignment, benchmark, Question Answering, expert knowledge</td>
...
<td style="padding: 8px;">self-verification, logical reasoning, fallacy detection, LLMs, scalable oversight</td>
...
<td style="padding: 8px;">reward modeling, scalable alignment, Principle-Based Alignment, LLM Alignment, Synthetic Data</td>
...
<td style="padding: 8px;">scalable oversight, LLM Evaluation, Climate Change Communication, Epistemological Adequacy, AI Assistance</td>
...
<td style="padding: 8px;">explainability, AI policy, regulation, AI Oversight, transparency</td>
...
<td style="padding: 8px;">scalable oversight, Adversarial Attacks, Interpretability, Red Teaming, automated diagnostics</td>
...
<td style="padding: 8px;">scalable oversight, Language Models, Human-AI Collaboration, Alignment, empirical evaluation</td>
